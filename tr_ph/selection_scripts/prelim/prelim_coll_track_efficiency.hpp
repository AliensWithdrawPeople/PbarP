...
// Wed Sep 13 13:22:46 2023 by ROOT version 6.24/06
// from TTree tr_ph/Tree with the non-collinear events
// found on file: root://cmd//scan2021/scan2021_tr_ph_fc_e970_v9.root
//////////////////////////////////////////////////////////

#ifndef prelim_coll_track_efficiency_hpp
#define prelim_coll_track_efficiency_hpp
...
class prelim_coll_track_efficiency {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         phen[43];   //[nph]
   Float_t         phth[43];   //[nph]
   Float_t         phphi[43];   //[nph]
   Float_t         phrho[43];   //[nph]
   Float_t         phrad[43];   //[nph]
   Float_t         phen0[43];   //[nph]
   Float_t         phth0[43];   //[nph]
   Float_t         phphi0[43];   //[nph]
   Float_t         phlxe[43];   //[nph]
   Float_t         phslxe_layers[43][14];   //[nph]
   Float_t         pherr[43][3];   //[nph]
   Float_t         phcsi[43];   //[nph]
   Float_t         phbgo[43];   //[nph]
   Int_t           phflag[43];   //[nph]
   Int_t           phconv[43];   //[nph]
   Int_t           phfc[43];   //[nph]
   Int_t           nzcs_total;
   ...
   prelim_coll_track_efficiency(TTree *tree=0);
   virtual ~prelim_coll_track_efficiency();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(std::string new_file_name);
...
#ifdef prelim_coll_track_efficiency_cxx
prelim_coll_track_efficiency::prelim_coll_track_efficiency(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmd//scan2021/scan2021_tr_ph_fc_e970_v9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmd//scan2021/scan2021_tr_ph_fc_e970_v9.root");
      }
...
prelim_coll_track_efficiency::~prelim_coll_track_efficiency()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prelim_coll_track_efficiency::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prelim_coll_track_efficiency::LoadTree(Long64_t entry)
{
...
void prelim_coll_track_efficiency::Init(TTree *tree)
{
...
Bool_t prelim_coll_track_efficiency::Notify()
{
...
void prelim_coll_track_efficiency::Show(Long64_t entry)
{
...
Int_t prelim_coll_track_efficiency::Cut(Long64_t entry)
{
