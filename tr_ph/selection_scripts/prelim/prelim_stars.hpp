...
#ifndef prelim_stars_hpp
#define prelim_stars_hpp
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   prelim_stars(TTree *tree=0);
   virtual ~prelim_stars();
...
#ifdef prelim_stars_cxx
prelim_stars::prelim_stars(TTree *tree) : fChain(0) 
{
...
prelim_stars::~prelim_stars()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prelim_stars::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prelim_stars::LoadTree(Long64_t entry)
{
...
void prelim_stars::Init(TTree *tree)
{
...
void prelim_stars::Show(Long64_t entry)
{
...
Int_t prelim_stars::Cut(Long64_t entry)
{
