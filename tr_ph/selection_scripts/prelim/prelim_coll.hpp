...
#ifndef prelim_coll_hpp
#define prelim_coll_hpp
...
#ifdef prelim_coll_cxx
prelim_coll::prelim_coll(TTree *tree) : fChain(0) 
{
...
prelim_coll::~prelim_coll()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prelim_coll::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prelim_coll::LoadTree(Long64_t entry)
{
...
void prelim_coll::Init(TTree *tree)
{
...
void prelim_coll::Show(Long64_t entry)
{
...
Int_t prelim_coll::Cut(Long64_t entry)
{
