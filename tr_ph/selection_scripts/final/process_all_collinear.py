...
import pathlib
from config import prelim_root_files_folder, final_root_files_folder


raw_files = [x for x in prelim_root_files_folder.iterdir() if x.is_file() and x.suffix == '.root']
