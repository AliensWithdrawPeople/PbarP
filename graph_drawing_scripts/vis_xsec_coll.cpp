...
int xsec_coll()
{
    ...
    //// season2019
    std::vector<double> energy_season2019 ={936, 945, 950, 955, 962.5, 975, 978, 987.5}; // MeV
    ...
    //// season2020
    std::vector<double> energy_season2020 ={935, 945, 950, 960, 970}; // MeV
    ...
    //// season2021
    std::vector<double> energy_season2021 ={1003.5, 970, 980, 990}; // MeV
    ...
    //// season2022
    std::vector<double> energy_season2022 ={920, 930, 935, 937.5, 938.3, 938.9, 939.6, 940.2, 941, 942, 943.5, 945, 947.5, 948.75, 950, 951, 952, 953, 954}; // MeV
    ...
    std::vector<double> xsec_season2019 = {0.0052, 0.0035, 0.0025, 0.2614, 0.4046, 0.4806, 0.4837, 0.5096};
    std::vector<double> xsec_err_season2019 = {0.0017, 0.0012, 0.0011, 0.0144, 0.0139, 0.011, 0.0327, 0.015};
    ...
    std::vector<double> xsec_season2020 = {0.0022, 0.0024, 0.0035, 0.3924, 0.4637};
    std::vector<double> xsec_err_season2020 = {0.0005, 0.0005, 0.0006, 0.0063, 0.0073};
    ...
    std::vector<double> xsec_season2021 = {0.5299, 0.4524, 0.493, 0.5064};
    std::vector<double> xsec_err_season2021 = {0.005, 0.0091, 0.0067, 0.0071};
    ...
    std::vector<double> xsec_season2022 = {0.0041, 0.003, 0.0038, 0.0032, 0.0032, 0.0028, 0.0029, 0.0032, 0.0033, 0.0034, 0.0032, 0.0037, 0.0025, 0, 0.0034, 0.0098, 0.0438, 0.0785, 0.0955};
    std::vector<double> xsec_err_season2022 = {0.0006, 0.0005, 0.0005, 0.0006, 0.0005, 0.0005, 0.0005, 0.0005, 0.0006, 0.0006, 0.0006, 0.0006, 0.0005, 0, 0.0008, 0.0013, 0.0028, 0.0036, 0.0042};
