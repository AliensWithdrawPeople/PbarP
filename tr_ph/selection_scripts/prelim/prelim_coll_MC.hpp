...
#ifndef prelim_coll_MC_hpp
#define prelim_coll_MC_hpp
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   prelim_coll_MC(TTree *tree=0);
   virtual ~prelim_coll_MC();
...
#ifdef prelim_coll_MC_cxx
prelim_coll_MC::prelim_coll_MC(TTree *tree) : fChain(0) 
{
...
prelim_coll_MC::~prelim_coll_MC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t prelim_coll_MC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prelim_coll_MC::LoadTree(Long64_t entry)
{
...
void prelim_coll_MC::Init(TTree *tree)
{
...
void prelim_coll_MC::Show(Long64_t entry)
{
...
Int_t prelim_coll_MC::Cut(Long64_t entry)
{
...
#endif // #ifdef prelim_coll_MC_cxx
